...
String.prototype.startsWith = String.prototype.startsWith || function(a) { return this.slice(0, a.length) === a };
...
THREE.Color.prototype = {
    ...
    getContextStyle: function() { return "rgb(" + (255 * this.r | 0) + "," + (255 * this.g | 0) + "," + (255 * this.b | 0) + ")" },
...
THREE.Vector2.prototype = {
    ...
    isZero: function(a) { return this.lengthSq() < (void 0 !== a ? a : 1E-4) },
...
THREE.Vector3.prototype = {
    ...
    angleTo: function(a) { return Math.acos(this.dot(a) / this.length() / a.length()) },
    distanceTo: function(a) { return Math.sqrt(this.distanceToSquared(a)) },
    distanceToSquared: function(a) {
...
THREE.Matrix4.prototype = {
    ...
    getPosition: function() { var a = this.elements; return THREE.Matrix4.__v1.set(a[12], a[13], a[14]) },
    ...
    makeScale: function(a,
        b, c) { this.set(a, 0, 0, 0, 0, b, 0, 0, 0, 0, c, 0, 0, 0, 0, 1); return this },
...
(function(a) {
    ...
    var b = new a.Vector3,
        ...
        g = new a.Vector3,
        h = new a.Matrix4,
        i = function(a, b) { return a.distance - b.distance },
        j = new a.Vector3,
        l = new a.Vector3,
        m = new a.Vector3,
        n = function(a, b, c) {
        ...
        o = function(i, l, j) {
            ...
            if (i instanceof a.Particle) {
                ...
                o = { distance: m, point: i.position, face: null, object: i };
                j.push(o)
                ...
                for (A = y.faces.length; q < A; q++)
                    if (o = y.faces[q], m = !0 === H ? G[o.materialIndex] : i.material, void 0 !== m && (J = m.side, e.sub(o.centroid, c), f = o.normal, m = d.dot(f), !(Math.abs(m) < M) && (v = f.dot(e) / m, !(0 > v) && (J === a.DoubleSide ||
                        ...
                        if (g.add(c, d.multiplyScalar(v)), o instanceof a.Face3) m = C[o.a], v = C[o.b], J = C[o.c], p(g, m, v, J) && (v = i.matrixWorld.multiplyVector3(g.clone()), m = b.distanceTo(v), m < l.near || m > l.far || (o = { distance: m, point: v, face: o, faceIndex: q, object: i }, j.push(o)));
                        else if (o instanceof a.Face4 && (m = C[o.a], v = C[o.b], J = C[o.c], E = C[o.d], p(g, m, v, E) || p(g, v, J, E))) v = i.matrixWorld.multiplyVector3(g.clone()), m = b.distanceTo(v), m < l.near || m > l.far || (o = { distance: m, point: v, face: o, faceIndex: q, object: i }, j.push(o))
            }
        },
        q = function(a, b, c) { for (var a = a.getDescendants(), d = 0, e = a.length; d < e; d++) o(a[d], b, c) };
...
THREE.Object3D.prototype = {
    ...
    localToWorld: function(a) { return this.matrixWorld.multiplyVector3(a) },
    worldToLocal: function(a) { return THREE.Object3D.__m1.getInverse(this.matrixWorld).multiplyVector3(a) },
    lookAt: function(a) {
...
THREE.Projector = function() {
    ...
    var e, f, g = [],
        ...
        v, y, C = [],
        G = 0,
        H = { objects: [], sprites: [], lights: [], elements: [] },
        J = new THREE.Vector3,
        E = new THREE.Vector4,
        M = new THREE.Matrix4,
        K = new THREE.Matrix4,
                ...
                for (la = Ua.length; fa < la; fa++)
                    if (O = Ua[fa], Ra = !0 === ib ? Ia[O.materialIndex] : ca.material, void 0 !== Ra) {
                        ...
                        for (V = Va.length; W < V; W++)
                            if (na = Va[W][fa], void 0 !== na) { ia = 0; for (Z = na.length; ia < Z; ia++) n.uvs[W][ia] = na[ia] }
                        n.color = O.color;
                        n.material = Ra;
...
THREE.BufferGeometry.prototype = {
    ...
    computeVertexNormals: function() {
        if (this.attributes.position && this.attributes.index) {
            ...
            else { a = 0; for (b = this.attributes.normal.array.length; a < b; a++) this.attributes.normal.array[a] = 0 }
            var e = this.offsets,
...
THREE.Camera.prototype.lookAt = function(a) { this.matrix.lookAt(this.position, a, this.up);!0 === this.rotationAutoUpdate && this.rotation.setEulerFromRotationMatrix(this.matrix, this.eulerOrder) };
...
THREE.BinaryLoader.prototype.loadAjaxBuffers = function(a, b, c, d, e) {
    ...
    f.onreadystatechange = function() {
        ...
        else 3 == f.readyState ? e && (0 == h && (h = f.getResponseHeader("Content-Length")), e({ total: h, loaded: f.responseText.length })) :
...
THREE.BinaryLoader.prototype.createBinModel = function(a, b, c, d) {
    var e = function(b) {
        ...
        function z(a) { return a % 4 ? 4 - a % 4 : 0 }

        function A(a, b) { return (new Uint8Array(a, b, 1))[0] }

        function v(a, b) { return (new Uint32Array(a, b, 1))[0] }
        ...
        function H(b, c, d) { for (var e, f, g, h, i, c = new Uint32Array(a, c, 4 * b), j = new Uint16Array(a, d, b), d = 0; d < b; d++) e = c[4 * d], f = c[4 * d + 1], g = c[4 * d + 2], h = c[4 * d + 3], i = j[d], M.faces.push(new THREE.Face4(e, f, g, h, null, null, i)) }
        ...
        if (n) { K = new Int8Array(a, K, 3 * n); for ($ = 0; $ < n; $++) Y = K[3 * $], N = K[3 * $ + 1], ea = K[3 * $ + 2], F.push(Y / 127, N / 127, ea / 127) }
        K = m + 3 * n * Int8Array.BYTES_PER_ELEMENT;
        n = K += z(3 * n);
        if (p) { K = new Float32Array(a, K, 2 * p); for (m = 0; m < p; m++) $ = K[2 * m], Y = K[2 * m + 1], I.push($, Y) }
...
THREE.JSONLoader.prototype.createModel = function(a, b, c) {
    ...
    if (a.skinWeights) { c = 0; for (i = a.skinWeights.length; c < i; c += 2) u = a.skinWeights[c], s = a.skinWeights[c + 1], d.skinWeights.push(new THREE.Vector4(u, s, 0, 0)) }
    if (a.skinIndices) {
        c = 0;
...
THREE.GeometryLoader.prototype = {
    ...
    load: function(a) {
        ...
        d.addEventListener("load", function(d) { d.target.responseText ? c = b.parse(JSON.parse(d.target.responseText), e) : b.dispatchEvent({ type: "error", message: "Invalid file [" + a + "]" }) }, !1);
        d.addEventListener("error", function() { b.dispatchEvent({ type: "error", message: "Couldn't load URL [" + a + "]" }) }, !1);
        d.open("GET", a, !0);
        d.send(null);
        var e = new THREE.LoadingMonitor;
        e.addEventListener("load", function() { b.dispatchEvent({ type: "load", content: c }) });
        e.add(d)
    },
    parse: function(a, b) {
        var c = this,
        ...
        if (a.materials) {
            ...
            for (var f = 0; f < a.materials.length; ++f) {
                var g = a.materials[f],
                    h = function(a) { a = Math.log(a) / Math.LN2; return Math.floor(a) == a },
                    i = function(a) { a = Math.log(a) / Math.LN2; return Math.pow(2, Math.round(a)) },
                    j = function(a, d, e, f, g, l) {
                        ...
                        if (l && (f = { repeat: THREE.RepeatWrapping, mirror: THREE.MirroredRepeatWrapping }, void 0 !== f[l[0]] && (a[d].wrapS = f[l[0]]), void 0 !== f[l[1]])) a[d].wrapT = f[l[1]];
                        var j = a[d],
                    ...
                    l = function(a) { return (255 * a[0] << 16) + (255 * a[1] << 8) + 255 * a[2] },
                    m = "MeshLambertMaterial",
                    n = { color: 15658734, opacity: 1, map: null, lightMap: null, normalMap: null, bumpMap: null, wireframe: !1 };
                if (g.shading) { var p = g.shading.toLowerCase(); "phong" === p ? m = "MeshPhongMaterial" : "basic" === p && (m = "MeshBasicMaterial") }
        ...
        if (a.skinWeights) { f = 0; for (g = a.skinWeights.length; f < g; f += 2) d.skinWeights.push(new THREE.Vector4(a.skinWeights[f], a.skinWeights[f + 1], 0, 0)) }
        if (a.skinIndices) { f = 0; for (g = a.skinIndices.length; f < g; f += 2) n = 0, d.skinIndices.push(new THREE.Vector4(a.skinIndices[f], a.skinIndices[f + 1], n, 0)) }
        d.bones = a.bones;
        d.animation = a.animation;
        if (a.morphTargets) {
            f = 0;
...
THREE.SceneLoader.prototype.parse = function(a, b, c) {
    function d(a, b) { return "relativeToHTML" == b ? a : j + "/" + a }
    ...
    function g(a) { return function(b) { I.geometries[a] = b } }

    function h() {
        i.callbackProgress({ totalModels: K, totalTextures: F, loadedModels: K - E, loadedTextures: F - M }, I);
        i.onLoadProgress();
        0 === E && 0 === M && b(I)
    }
    var i = this,
    ...
    M = E = 0;
    I = { scene: new THREE.Scene, geometries: {}, materials: {}, textures: {}, objects: {}, cameras: {}, lights: {}, fogs: {}, empties: {} };
    ...
    for (q in L.textures)
        if (l = L.textures[q], l.url instanceof Array) { M += l.url.length; for (J = 0; J < l.url.length; J++) i.onLoadStart() } else M += 1, i.onLoadStart();
    F = M;
    for (q in L.textures) {
        l =
            L.textures[q];
        ...
        if (l.url instanceof Array) {
            ...
            if (l.wrap && (o = { repeat: THREE.RepeatWrapping, mirror: THREE.MirroredRepeatWrapping }, void 0 !== o[l.wrap[0]] && (J.wrapS = o[l.wrap[0]]), void 0 !== o[l.wrap[1]])) J.wrapT =
                o[l.wrap[1]]
        }
        I.textures[q] = J
    }
    for (m in L.materials) {
        ...
        r.parameters.normalMap ? (q = THREE.ShaderUtils.lib.normal, a = THREE.UniformsUtils.clone(q.uniforms), l =
            ...
            (a.uOpacity.value = r.parameters.opacity), C = new THREE.ShaderMaterial({ fragmentShader: q.fragmentShader, vertexShader: q.vertexShader, uniforms: a, lights: !0, fog: !0 })) : C = new THREE[r.type](r.parameters);
        I.materials[m] = C
    }
    e(I.scene, L.objects);
    i.callbackSync(I);
...
THREE.Material.prototype.deallocate = function() { var a = THREE.MaterialLibrary.indexOf(this); - 1 !== a && THREE.MaterialLibrary.splice(a, 1) };
...
THREE.MeshFaceMaterial.prototype.clone = function() { return new THREE.MeshFaceMaterial };
...
THREE.ParticleDOMMaterial = function(a) { this.element = a };
THREE.ParticleDOMMaterial.prototype.clone = function() { return new THREE.ParticleDOMMaterial(this.element) };
...
THREE.CanvasRenderer = function(a) {
    function b(a) { B !== a && (B = q.globalAlpha = a) }

    function c(a) { u !== a && (a === THREE.NormalBlending ? q.globalCompositeOperation = "source-over" : a === THREE.AdditiveBlending ? q.globalCompositeOperation = "lighter" : a === THREE.SubtractiveBlending && (q.globalCompositeOperation = "darker"), u = a) }

    function d(a) { s !== a && (s = q.strokeStyle = a) }

    function e(a) { z !== a && (z = q.fillStyle = a) }
    ...
    this.render = function(a, l) {
        ...
        function tb(a, b, c) { a = (a - b) / (c - b); return a * a * (3 - 2 * a) }

        function jc(a) { a = 0.5 * (a + 1); return 0 > a ? 0 : 1 < a ? 1 : a }
...
THREE.ShaderLib = {
    ...
    lambert: {
        uniforms: THREE.UniformsUtils.merge([THREE.UniformsLib.common,
            THREE.UniformsLib.fog, THREE.UniformsLib.lights, THREE.UniformsLib.shadowmap, { ambient: { type: "c", value: new THREE.Color(16777215) }, emissive: { type: "c", value: new THREE.Color(0) }, wrapRGB: { type: "v3", value: new THREE.Vector3(1, 1, 1) } }
        ]),
...
THREE.WebGLRenderer = function(a) {
    ...
    function c(a, b) { if (a.material && !(a.material instanceof THREE.MeshFaceMaterial)) return a.material; if (0 <= b.materialIndex) return a.geometry.materials[b.materialIndex] }
    ...
    function e(a) { return a.map || a.lightMap || a.bumpMap || a.normalMap || a.specularMap || a instanceof THREE.ShaderMaterial ? !0 : !1 }
    ...
    function i(a, b) { return b.z - a.z }

    function j(a, b) { return b[1] - a[1] }
    ...
    function p(a, b, c) { a.push({ buffer: b, object: c, opaque: null, transparent: null }) }
    ...
    function r(a, b) { for (var c = a.length - 1; 0 <= c; c--) a[c].object === b && a.splice(c, 1) }
    ...
    function v(a, b, c) { eb !== a && (a ? k.enable(k.POLYGON_OFFSET_FILL) : k.disable(k.POLYGON_OFFSET_FILL), eb = a); if (a && (pb !== b || Pb !== c)) k.polygonOffset(b, c), pb = b, Pb = c }

    function y(a) { for (var a = a.split("\n"), b = 0, c = a.length; b < c; b++) a[b] = b + 1 + ": " + a[b]; return a.join("\n") }
    ...
    function J(a) { return a === THREE.NearestFilter || a === THREE.NearestMipMapNearestFilter || a === THREE.NearestMipMapLinearFilter ? k.NEAREST : k.LINEAR }
    ...
    function E(a) {
        ...
        if (void 0 !== yb) { if (a === THREE.RGB_S3TC_DXT1_Format) return yb.COMPRESSED_RGB_S3TC_DXT1_EXT; if (a === THREE.RGBA_S3TC_DXT1_Format) return yb.COMPRESSED_RGBA_S3TC_DXT1_EXT; if (a === THREE.RGBA_S3TC_DXT3_Format) return yb.COMPRESSED_RGBA_S3TC_DXT3_EXT; if (a === THREE.RGBA_S3TC_DXT5_Format) return yb.COMPRESSED_RGBA_S3TC_DXT5_EXT }
        return 0
    }
    ...
    var Q = this,
        ...
        k, Qb, yb;
    try { if (!(k = M.getContext("experimental-webgl", { alpha: F, premultipliedAlpha: I, antialias: L, stencil: R, preserveDrawingBuffer: $ }))) throw "Error creating WebGL context."; } catch (Sc) { console.error(Sc) }
    ...
    this.supportsVertexTextures = function() { return hc };
    this.getMaxAnisotropy = function() { return Ec };
    this.setSize = function(a, b) {
        M.width = a;
        M.height = b;
    ...
    this.setScissor = function(a, b, c, d) { k.scissor(a, b, c, d) };
    ...
    this.getClearColor = function() { return Y };
    this.getClearAlpha = function() { return N };
        ...
        if (a.__webglInit)
            if (a.__webglInit = !1, delete a._modelViewMatrix, delete a._normalMatrix, delete a._normalMatrixArray, delete a._modelViewMatrixArray, delete a._modelMatrixArray,
                ...
                for (var b in a.geometry.geometryGroups) {
                    ...
                    if (c.numMorphNormals) { d = 0; for (e = c.numMorphNormals; d < e; d++) k.deleteBuffer(c.__webglMorphNormalsBuffers[d]) }
    ...
    this.deallocateTexture = function(a) { a.__webglInit && (a.__webglInit = !1, k.deleteTexture(a.__webglTexture), Q.info.memory.textures--) };
    ...
    this.renderImmediateObject = function(a, b, c, d, e) {
        ...
        e.immediateRenderCallback ? e.immediateRenderCallback(f, k, fb) : e.render(function(a) { Q.renderBufferImmediate(a, f, d) })
    };
    ...
    this.initMaterial = function(a, b, c, d) {
        ...
        a: {
            ...
            v.attributes[u] = k.getAttribLocation(v, u);v.id = la++;qa.push({ program: v, code: n, usedTimes: 1 });Q.info.memory.programs = qa.length;r = v
        }
        a.program = r;
    ...
    this.setFaceCulling = function(a, b) { a ? (!b || "ccw" === b ? k.frontFace(k.CCW) : k.frontFace(k.CW), "back" === a ? k.cullFace(k.BACK) : "front" === a ? k.cullFace(k.FRONT) : k.cullFace(k.FRONT_AND_BACK), k.enable(k.CULL_FACE)) : k.disable(k.CULL_FACE) };
    ...
    this.setDepthTest = function(a) { ib !== a && (a ? k.enable(k.DEPTH_TEST) : k.disable(k.DEPTH_TEST), ib = a) };
    this.setDepthWrite = function(a) { Ra !== a && (k.depthMask(a), Ra = a) };
    this.setBlending = function(a, b, c, d) {
        ...
        if (a === THREE.CustomBlending) { if (b !== Ua && (k.blendEquation(E(b)), Ua = b), c !== na || d !== Va) k.blendFunc(E(c), E(d)), na = c, Va = d } else Va = na = Ua = null
    };
...
THREE.GeometryUtils = {
    ...
    randomPointsInGeometry: function(a, b) {
        function c(a) {
            function b(c, d) { if (d < c) return c; var e = c + Math.floor((d - c) / 2); return j[e] > a ? b(c, e - 1) : j[e] < a ? b(e + 1, d) : e }
...
(function(a) {
    ...
    a.Triangulate = function(a, d) {
        ...
        var m = 2 * e;
        for (j = e - 1; e > 2;) {
            if (m-- <= 0) { console.log("Warning, unable to triangulate polygon!"); break }
            i = j;
            e <= i && (i = 0);
            j = i + 1;
            e <= j && (j = 0);
                    ...
                    for (B = 0; B < r; B++)
                        if (!(B == p || B == o || B == q)) {
                            var C = n[t[B]].x,
                                ...
                                K = K * L - F * I,
                                E = E * N - M * Y;
                            if (H >= 0 && E >= 0 && K >= 0) { n = false; break a }
                        }
                    n = true
                }
            }
...
THREE.CurvePath.prototype.createPointsGeometry = function(a) { a = this.getPoints(a, true); return this.createGeometry(a) };
THREE.CurvePath.prototype.createSpacedPointsGeometry = function(a) { a = this.getSpacedPoints(a, true); return this.createGeometry(a) };
...
THREE.AnimationHandler = function() {
    var a = [],
                            ...
                            for (d = 0; d < a.hierarchy[c].keys.length; d++) {
                                ...
                                for (j in h) {
                                    for (i = 0; i < a.hierarchy[c].keys[d].morphTargets.length; i++)
                                        if (a.hierarchy[c].keys[d].morphTargets[i] === j) { l[j] = a.hierarchy[c].keys[d].morphTargetsInfluences[i]; break }
        ...
        d = function(a, b) { b.push(a); for (var c = 0; c < a.children.length; c++) d(a.children[c], b) };
    c.LINEAR = 0;
    c.CATMULLROM =
        1;
...
THREE.CubeGeometry = function(a, b, c, d, e, f, g, h) {
    ...
    if (g !== void 0) {
        ...
        else { this.materials = []; for (p = 0; p < 6; p++) this.materials.push(g) }
        p = 0;
        r = 1;
        o = 2;
        t = 3;
...
THREE.ConvexGeometry = function(a) {
    function b(a) { var b = a.length(); return new THREE.UV(a.x / b, a.y / b) }
    THREE.Geometry.call(this);
    for (var c = [
            [0, 1, 2],
            [0, 2, 1]
...
THREE.CameraHelper.prototype.update = function() {
    function a(a, d, e, f) {
        ...
        a = b.pointMap[a];
        if (a !== void 0) { d = 0; for (e = a.length; d < e; d++) b.geometry.vertices[a[d]].copy(THREE.CameraHelper.__v) }
    }
    var b = this;
...
THREE.GeometryUtils.orderedKey = function(a, b) { return Math.min(a, b) + "_" + Math.max(a, b) };
...
THREE.SubdivisionModifier.prototype.smooth = function(a) {
    function b() { l.debug && (console && console.assert) && console.assert.apply(console, arguments) }

    function c() { l.debug && console.log.apply(console, arguments) }

    function d() { console && console.log.apply(console, arguments) }
...
THREE.ShadowMapPlugin = function() {
    ...
    this.init = function(g) {
        ...
        d = new THREE.ShaderMaterial({ fragmentShader: g.fragmentShader, vertexShader: g.vertexShader, uniforms: h, morphTargets: true });
        ...
        f = new THREE.ShaderMaterial({ fragmentShader: g.fragmentShader, vertexShader: g.vertexShader, uniforms: h, morphTargets: true, skinning: true });
        c._shadowPass = true;
        d._shadowPass = true;
        e._shadowPass = true;
        f._shadowPass = true
    ...
    this.update = function(l, m) {
        ...
        for (p = z.length; n < p; n++) {
            o = z[n];
            if (!o.shadowMap) {
                o.shadowMap = new THREE.WebGLRenderTarget(o.shadowMapWidth, o.shadowMapHeight, { minFilter: THREE.LinearFilter, magFilter: THREE.LinearFilter, format: THREE.RGBAFormat });
